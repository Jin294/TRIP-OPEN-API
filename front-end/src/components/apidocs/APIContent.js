		...
		<div className={styles.contentBody}>
			<div>
					...
					<tbody>
						<tr>
							...
							<td>
								...
								토큰은 로그인 후 우측상단의 '내 API 토큰' 버튼을 눌러 확인 하실 수 있습니다. 토큰은
								API 요청의 헤더의 Authorization 필드에 담아 보내주세요, 이를 통해 사용자를
								식별합니다.
							</td>
						</tr>
						<tr>
				...
				<div className={styles.testDiv}>
					...
					<h4>* 요청 변수(Request Parameter)</h4>
					{isRequestTrueData.length > 0 && (
						<table style={{ marginBottom: "2%" }} className={styles.apiRequestDataTable}>
							<thead>
								<tr>
									<th>HTTP</th>
									<th>항목명</th>
