      ...
      <div className={styles.mypageContainer}>
        ...
        <div className={styles.textBox}>
          ...
          <img
            alt=""
            src={copyImg}
            onClick={() => handleCopyClipBoardToken({ apiToken })}
          />
        </div>
        <button
          className={styles.apiTokenRefreshBtn}
          onClick={onClickapiTokenRefreshBtn}
        >
          토큰 재발급
        </button>
        <input
        ...
        <button
          className={styles.apiTokenRefreshBtn}
          onClick={onClickAddRedirectURI}
        >
          RedirectURI <br></br>추가하기
        </button>
        {/*redirectURI 목록*/}
          ...
          <div key={client.client_id} className={styles.client}>
            ...
            <div className={styles.textBox}>
              ...
              <img
                ...
                src={copyImg}
                onClick={() =>
                  handleCopyClipBoard(client.web_server_redirect_uri)
                }
              />
            </div>
            ...
            <div className={styles.textBox}>
              ...
              <img
                alt=""
                src={copyImg}
                onClick={() => handleCopyClipBoard(client.client_id)}
              />
            </div>
            ...
            <div className={styles.textBox}>
              ...
              <img
                alt=""
                src={copyImg}
                onClick={() => handleCopyClipBoard(client.client_secret)}
              />
            </div>
          </div>
        ))}
