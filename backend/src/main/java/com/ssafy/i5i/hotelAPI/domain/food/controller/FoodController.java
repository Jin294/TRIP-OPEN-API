...
public class FoodController {
	...
	public List<FoodCoordiResponseDto> getFoodFromLngLatv(@PathVariable("longtitude")Double longitude, @PathVariable("latitude")Double latitude, @PathVariable("distance")Long distance, @PathVariable("sorted")String sorted){
